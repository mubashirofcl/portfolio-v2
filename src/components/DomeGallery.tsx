...
export type DomeGalleryImageSource = string | DomeGalleryImage;
...
function buildItems(pool: DomeGalleryImageSource[], seg: number): CoordsItem[] {
  ...
  useGesture(
    {
      ...
      onDrag: ({ last, velocity = [0, 0], direction = [0, 0], movement, xy: [clientX, clientY] }) => {
        ...
        <div className="stage">
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                <div
                  className="item__image animate-fade-in"
                  role="button"
                  tabIndex={0}
